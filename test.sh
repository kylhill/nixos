...
shell_files=(apply.sh test.sh update.sh scripts/install-host-key scripts/install-preflight scripts/nix-sandbox tests/test-runner.sh tests/fixtures/validation-tool)
